...
std::string HelpMessageCli()
{
    ...
    strUsage += HelpMessageOpt("-rpcwallet=<walletname>", _("Send RPC for non-default wallet on RPC server (argument is wallet filename in hawkcoind directory, required if hawkcoind/-Qt runs with multiple wallets)"));
