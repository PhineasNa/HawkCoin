...
{
    const char* pszTimestamp = "MarketWatch 12/14/2021 Errant quotes made cryptocurrency investors ‘quadrillionaires’ on paper today. Here’s how the crypto community reacted.";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 0.5 * 24 * 60 * 60; // half a day
        ...
        genesis = CreateGenesisBlock(1639537526, 95487, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("de1e50f99fd112dfd3182161113889eea2f61f5459824cffb537cff36d3bf275"));
        assert(genesis.hashMerkleRoot == uint256S("ea178d16fc4cf2f29e6bb5e5ccc2d654ed43381d5539e54a568522a26b97a711"));
        ...
        checkpointData = (CCheckpointData) {
            {
            	{     0, uint256S("de1e50f99fd112dfd3182161113889eea2f61f5459824cffb537cff36d3bf275")},
            	/*
        ...
        chainTxData = ChainTxData{
            ...
            1639537526, // * UNIX timestamp of last known number of transactions
