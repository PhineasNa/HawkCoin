...
It is possible to run Hawkcoin as a Tor hidden service, and connect to such services.
...
The first step is running Hawkcoin behind a Tor proxy. This will already make all
...
Hawkcoin Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if Hawkcoin Core is listening (`-listen`), and
