...
*Setup instructions for a Gitian build of Hawkcoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Hawkcoin
...
- [Building Hawkcoin Core](#building-litecoin-core)
...
Building Hawkcoin Core
----------------

To build Hawkcoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
