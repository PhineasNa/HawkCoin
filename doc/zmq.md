...
The Hawkcoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Hawkcoin Core requires ZeroMQ API version 4.x or
...
using. Hawkcoind appends an up-counting sequence number to each
